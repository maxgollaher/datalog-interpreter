...
class Parser {
private:
    vector<Token> tokens; // vector object containing a list of tokens generated by the Lexer class
...
public:
     ...
     * by the Lexer class. As it parses the data, it creates Predicate objects and
    ...
    /** This recursive function parses through the tokens provided by the Lexer and adds parameter
    ...
    /** This recursive parses through the tokens provided by the Lexer and adds parameter
   * objects to a Predicate object.
   * @param pred: A predicate object that parameters will be added to*/
   ...
   * fact object is NOT found */
    ...
    * @param datalogProgram: the DatalogProgram object to be modified */
    ...
    /**Recursive function that parses the tokens generated by the Lexer to add to
     * a Predicate vector.
    * @param paramVector: the vector object to be modified */
    ...
    /**Creates a Rule object using the tokens generated by the Lexer in the form:
